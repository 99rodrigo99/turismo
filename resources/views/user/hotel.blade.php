...
@section('content')
    <main>
        ...
        <div class="container margin_60_35">
            ...
            <div class="wrapper-grid">
                <div class="row">
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="box_grid">
                            <figure>
                                <a href="hotels-grid.html#0" class="wish_bt"></a>
                                <a href="hotel-detail.html"><img src="img/hotel_1.jpg" class="img-fluid" alt="" width="800"
                                        height="533">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="box_grid">
                            <figure>
                                <a href="hotels-grid.html#0" class="wish_bt"></a>
                                <a href="hotel-detail.html"><img src="img/hotel_2.jpg" class="img-fluid" alt="" width="800"
                                        height="533">
                                    <div class="read_more"><span>Read more</span></div>
                                </a>
                                <small>Paris Centre</small>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="box_grid">
                            <figure>
                                <a href="hotels-grid.html#0" class="wish_bt"></a>
                                <a href="hotel-detail.html"><img src="img/hotel_3.jpg" class="img-fluid" alt="" width="800"
                                        height="533">
                                    <div class="read_more"><span>Read more</span></div>
                                </a>
                                <small>Paris Centre</small>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="box_grid">
                            <figure>
                                <a href="hotels-grid.html#0" class="wish_bt"></a>
                                <a href="hotel-detail.html"><img src="img/hotel_4.jpg" class="img-fluid" alt="" width="800"
                                        height="533">
                                    <div class="read_more"><span>Read more</span></div>
                                </a>
                                <small>Paris Centre</small>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="box_grid">
                            <figure>
                                <a href="hotels-grid.html#0" class="wish_bt"></a>
                                <a href="hotel-detail.html"><img src="img/hotel_5.jpg" class="img-fluid" alt="" width="800"
                                        height="533">
                                    <div class="read_more"><span>Read more</span></div>
                                </a>
                                <small>Paris Centre</small>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="box_grid">
                            <figure>
                                <a href="hotels-grid.html#0" class="wish_bt"></a>
                                <a href="hotel-detail.html"><img src="img/hotel_6.jpg" class="img-fluid" alt="" width="800"
                                        height="533">
                                    <div class="read_more"><span>Read more</span></div>
                                </a>
                                <small>Paris Centre</small>
            ...
            <p class="text-center"><a href="hotels-grid.html#0" class="btn_1 rounded add_top_30">Load more</a></p>
        ...
        <div class="bg_color_1">
            <div class="container margin_60_35">
                <div class="row">
                    <div class="col-md-4">
                        <a href="hotels-grid.html#0" class="boxed_list">
